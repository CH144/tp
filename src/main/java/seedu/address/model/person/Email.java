...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS =
            ...
            + "  1) only contain alphanumeric characters and " + SPECIAL_CHARACTERS + "\n"
            + "  2) not start or end with " + SPECIAL_CHARACTERS + "\n\n"
            + "and 'domain' must have domain labels where each should\n"
            + "  1) be separated by .\n"
            + "  2) only contain alphanumeric characters and -\n"
            + "  3) not start or end with -\n"
